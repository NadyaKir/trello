...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/nadezhda/Projects/trello/trello-backend/prisma/gnerated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "prisma/gnerated/client/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/gnerated/client/schema.prisma")
